...
export const RoadmapGenerator = ({ onComplete }) => {
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        {['No Restriction', 'Vegan', 'Vegetarian', 'Keto', 'Paleo', 'Gluten Free'].map((d) => (
                                            <button
                                                ...
                                                className={`px-3 py-3 rounded-xl text-sm font-medium border text-left transition-all ${formData.dietType === d
                                ...
                                <div className="space-y-4">
                                    ...
                                    {['Sedentary (Office Job)', 'Lightly Active (1-2 days/wk)', 'Moderately Active (3-5 days/wk)', 'Very Active (6+ days/wk)'].map((level) => (
                                        <button
                                            ...
                                            className={`w-full p-4 rounded-xl text-sm font-medium border text-left flex items-center justify-between transition-all ${formData.activityLevel === level
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        {['Lose Weight', 'Build Muscle', 'Endurance', 'Flexibility'].map((goal) => (
                                            <button
                                                ...
                                                className={`p-4 rounded-xl text-sm font-medium border text-left transition-all ${formData.goal === goal
                                                        ? 'bg-orange-500/20 border-orange-500 text-white'
                                                        : 'bg-slate-800 border-slate-700 text-slate-400 hover:border-slate-600'
                                                    }`}
                                            >
