                ...
                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-4 overflow-hidden">
                    <nav className="flex flex-row lg:flex-col gap-2 overflow-x-auto lg:overflow-visible">
                        <button
                            ...
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap ${view === 'browse' ? 'bg-cyan-500/10 text-cyan-400' : 'text-slate-400 hover:text-white hover:bg-slate-800'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap ${view === 'cart' ? 'bg-cyan-500/10 text-cyan-400' : 'text-slate-400 hover:text-white hover:bg-slate-800'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all whitespace-nowrap ${view === 'orders' ? 'bg-cyan-500/10 text-cyan-400' : 'text-slate-400 hover:text-white hover:bg-slate-800'
                                }`}
                        >
                        ...
                        <div className="space-y-2">
                            {['All', 'Supplements', 'Gear', 'Books'].map(cat => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors ${activeCategory === cat ? 'bg-slate-800 text-cyan-400' : 'text-slate-500 hover:text-slate-300'
                                        }`}
                                >
                                    {cat}
                                </button>
                            ...
                            <div className="flex gap-2 lg:hidden overflow-x-auto pb-1">
                                {['All', 'Supplements', 'Gear', 'Books'].map(cat => (
                                    <button
                                        key={cat}
                                        onClick={() => setActiveCategory(cat)}
                                        className={`px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap border ${activeCategory === cat ? 'bg-slate-800 text-cyan-400 border-slate-700' : 'bg-slate-900 text-slate-500 border-slate-800'
                                            }`}
                                    >
                                        {cat}
                                    </button>
